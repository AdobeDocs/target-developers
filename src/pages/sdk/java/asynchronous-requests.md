...
This example assumes you have [initialized the SDK](../initialize-sdk.md) as a spring bean and that you have [utility methods](/src/pages/sdk/java/utility-methods.md) available.
