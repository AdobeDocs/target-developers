...
|get_response()|[TargetDeliveryResponse](https://github.com/adobe/target-python-sdk/blob/main/target_python_sdk/types/target_delivery_response.py){target=_blank}|Returns the response object normally returned by `get_offers`|
