...
* **Learn from real-time analytics.** Gain insights from your activity performance in real time via [Analytics for Target](/help/main/c-integrating-target-with-mac/a4t/a4t.md) (A4T) reporting. A4T allows you to pivot your strategy at critical moments.
...
Using server-side only as the default configuration means that all decisions are made on the Target edge network, which involves a blocking server call. This approach can introduce incremental latency, but it also provides significant benefits, such as giving you the ability to apply Target’s machine-learning capabilities that include [Recommendations](/help/main/c-recommendations/recommendations.md), [Automated Personalization](/help/main/c-activities/t-automated-personalization/automated-personalization.md) (AP), and [Auto-Target](/help/main/c-activities/auto-target/auto-target-to-optimize.md) activities. 
...
You must have the Admin or Approver [user role](/help/main/administrating-target/c-user-management/user-management.md) to enable or disable the On-Device Decisioning toggle.
