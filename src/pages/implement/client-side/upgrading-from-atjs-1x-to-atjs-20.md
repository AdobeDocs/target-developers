...
at.js 2.*x*, just like at.js 1.*x*, uses the custom event `at-request-succeeded` to surface response tokens. For code examples using the `at-request-succeeded` custom event, see [Response tokens](/help/main/administrating-target/response-tokens.md).
...
Used for [Enterprise User Permissions](/help/main/administrating-target/c-user-management/property-channel/property-channel.md).
...
## Training video: at.js 2.*x* architectural diagram ![Overview badge](/help/main/assets/overview.png)
