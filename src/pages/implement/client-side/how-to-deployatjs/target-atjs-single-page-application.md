...
![Traditional page lifecycle vs. SPA lifecycle](/help/main/c-experiences/assets/trad-vs-spa.png)
...
To ensure that [Analytics for Target](/help/main/c-integrating-target-with-mac/a4t/a4t.md) (A4T) works correctly with at.js 2.x, be sure to send the same SDID in the Target request and in the Analytics request.
...
Although these examples use JavaScript code, all this can be simplified if you are using a tag manager, such as tags in [Adobe Experience Platform](/help/c-implementing-target/c-implementing-target-for-client-side-web/how-to-deployatjs/cmp-implementing-target-using-adobe-launch.md).
...
### Understanding how at.js 2.x works ![Overview badge](/help/main/assets/overview.png)
...
### Implement at.js 2.x in a SPA ![Tutorial badge](/help/main/assets/tutorial.png)
