...
description: Use the adobe.target.getOffers() function and its options for the Adobe [!DNL Target] at.js library to fire requests to get multiple [!DNL Target] offers. (at.js 2.x)
