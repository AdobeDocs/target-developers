...
description: Use the targetPageParams() function for the Adobe [!DNL Target] at.js JavaScript library to attach parameters to the global mbox from outside of the request code.
