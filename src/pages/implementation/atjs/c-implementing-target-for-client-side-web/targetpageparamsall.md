...
description: Use the targetPageParamsAll() function for the Adobe [!DNL Target] at.js JavaScript library to attach parameters to all mboxes from outside of the request code.
